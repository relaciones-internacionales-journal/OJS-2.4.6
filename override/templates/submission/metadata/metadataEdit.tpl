...
{call_hook name="Templates::Submission::MetadataEdit::Authors"}
	...
	<tr valign="top">
		<td>&nbsp;</td>
		<td class="value"><input type="submit" name="delAuthor[{$authorIndex|escape}]" value="{translate key="author.submit.deleteAuthor"}" class="btn btn-danger btn-sm" /></td>
	</tr>
	{/if}
...
<div id="metadata-supporting-agencies">
...
<p style="float:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-sm" onclick="history.go(-1)" /> <input type="submit" value="{translate key="submission.saveMetadata"}" class="btn btn-sm"/></p>
