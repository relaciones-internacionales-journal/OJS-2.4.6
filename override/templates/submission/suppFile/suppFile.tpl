...
{/if}
<div id="supplementary-file-data">
...
<div id="supplementary-file-upload">
...
{if $suppFile && $suppFile->getRemoteURL()}
	<tr valign="top">
		...
		<td width="80%" class="value"><input type="text" name="remoteURL" id="remoteURL" value="{$suppFile->getRemoteURL()|escape}" size="40" maxlength="255" class="btn btn-file btn-sm" /></td>
	</tr>
</table>
{else}
...
<p style="float:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-sm" onclick="history.go(-1)" /> <input type="submit" value="{translate key="common.save"}" class="btn btn-sm" /></p>
