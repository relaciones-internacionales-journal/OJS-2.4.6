...
{else}
	<tr valign="top">
		...
		<td class="value"><a class="action descargar-general" href="{url op="downloadFile" path=$articleId|to_array:$galley->getFileId()}">{$galley->getFileName()|escape}</a></td>
	</tr>
	<tr valign="top">
...
<tr valign="top">
	...
	<td class="value">
		<input type="file" name="styleFile" id="styleFile" class="uploadField btn btn-sm" />&nbsp;&nbsp;{translate key="form.saveToUpload"}
	</td>
</tr>
</table>
</div>
<br />
<div id="galley-images">
...
<p style="text-align:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-sm" onclick="document.location.href='{url op="submissionEditing" path=$articleId escape=false}'" /> <input type="submit" value="{translate key="common.save"}" class="btn btn-sm" /></p>
</form>
</div>
