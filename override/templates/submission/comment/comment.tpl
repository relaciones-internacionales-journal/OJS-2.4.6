...
<p><input type="button" value="{translate key="common.close"}" class="btn btn-danger btn-sm" onclick="window.close()" /> <input type="submit" name="saveAndEmail" value="{translate key="common.saveAndEmail"}" class="btn btn-sm" /> <input type="submit" name="save" value="{translate key="common.save"}" class="btn btn-sm" /></p>
