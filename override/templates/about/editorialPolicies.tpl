...
<div id="archiving"><div class="arrow-down-box"><h3>{translate key="about.archiving"}</h3></div>
...
{foreach key=key from=$currentJournal->getLocalizedSetting('customAboutItems') item=customAboutItem name=customAboutItems}
	{if !empty($customAboutItem.title)}
		<div id="custom-{$key|escape}"><div class="arrow-down-box"><h3>{$customAboutItem.title|escape}</h3></div>
