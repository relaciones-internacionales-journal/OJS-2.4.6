...
{/strip}
<div id="column-half-left">
<div id="aboutPeople">
<div class="about-block-title"><h3>{translate key="about.people"}</h3></div>
<ul class="plain">
...
<div class="about-block-title"><h3>{translate key="about.info"}</h3></div>
<ul class="plain">
...
<div id="column-half-right">
<div id="aboutSubmissions">
<div class="about-block-title"><h3>{translate key="about.submissions"}</h3></div>
<ul class="plain">
...
<div id="aboutOther">
<div class="about-block-title"><h3>{translate key="about.other"}</h3></div>
<ul class="plain">
