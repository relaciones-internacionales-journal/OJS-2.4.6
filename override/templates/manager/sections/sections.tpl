...
{else}
	<tr>
		<td align="left" class="table-results-pagination">{page_info iterator=$sections}</td>
		<td colspan="2" align="right" class="table-results-pagination">{page_links anchor="sections" name="sections" iterator=$sections}</td>
	</tr>
{/if}
</table>
<a class="action crear-general" href="{url op="createSection"}">{translate key="manager.sections.create"}</a>
</div>
