...
<div class="fileupload fileupload-new" data-provides="fileupload">
					...
					<input type="submit" value="{translate key="manager.files.uploadFile"}" class="btn btn-sm" />
				</div>
...
<form method="post" action="{url op="fileMakeDir" path=$currentDir|explode:"/"}" enctype="multipart/form-data">
	...
	<input type="submit" value="{translate key="manager.files.createDir"}" class="btn btn-sm" />
</form>
<hr/>
