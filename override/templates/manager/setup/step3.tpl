...
<div id="manager-author-guidelines-info">
...
<div id="manager-submission-preparation-checklist">
...
{foreach name=checklist from=$submissionChecklist[$formLocale] key=checklistId item=checklistItem}
	...
	<tr valign="top">
		...
		<td width="100%"><input type="submit" name="delChecklist[{$checklistId|escape}]" value="{translate key="common.delete"}" class="btn btn-sm" /></td>
	</tr>
{/foreach}
...
<p><input type="submit" name="addChecklist" value="{translate key="manager.setup.addChecklistItem"}" class="btn btn-sm" /></p>
</div>

<div class="separator"></div>

<div id="manager-permissions">
...
<p><input id="resetPermissionsButton" type="button" value="{translate key="manager.setup.resetPermissions"}" class="btn btn-sm" /></p>
</div>

<div class="separator"></div>

<div id="manager-competing-interests">
...
<div id="manager-for-authors-to-index-their-work">
...
<div id="manager-register-journal-for-indexing">
...
<div id="manager-citation-assistant">
...
{else}
	...
	<div id="manager-citation-filter-setup-toggle" {if !$metaCitations}style="visible: none"{/if}>
		<strong>{translate key="manager.setup.citationFilterParser"}</strong>
		...
		<strong>{translate key="manager.setup.citationFilterLookup"}</strong>
		...
		<strong>{translate key="manager.setup.citationOutput"}</strong>
