...
<div id="manager-security-settings">
<h3>4.1 {translate key="manager.setup.securitySettings"}</h3>
<div id="online-access-management">
...
<div id="manager-publication-scheduling">
...
<div id="frequency-of-publication">
...
<div id="manager-public-identifier">
...
<div id="manager-announcements-section">
...
<div id="announcements-introduction-section">
...
<div id="copyedit-instructions-section">
...
<div id="manager-layout-and-galleys">
...
<div id="layout-instructions-section">
...
{foreach name=templates from=$templates key=templateId item=template}
	<tr valign="top">
		...
		<td width="30%"><input type="submit" name="delTemplate[{$templateId|escape}]" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" /></td>
{/foreach}
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td width="80%" colspan="2" class="value"><input type="file" name="template-file" id="template-file" class="uploadField btn btn-sm" /><input type="submit" name="addTemplate" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
	</tr>
</table>
</div><!-- layoutTemplates -->

<div id="reference-linking">
...
<div id="ref-link-instructions-section">
