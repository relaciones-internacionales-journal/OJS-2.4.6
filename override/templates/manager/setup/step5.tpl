...
{/if}
<div id="manager-journal-homepage-header">
...
<table width="100%" class="data-alt">
	...
	<tr valign="top">
		...
		<td width="80%" class="value"><input type="file" name="homeHeaderTitleImage" class="uploadField" /> <input type="submit" name="uploadHomeHeaderTitleImage" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
	</tr>
</table>

{if $homeHeaderTitleImage[$formLocale]}
{translate key="common.fileName"}: {$homeHeaderTitleImage[$formLocale].name|escape} {$homeHeaderTitleImage[$formLocale].dateUploaded|date_format:$datetimeFormatShort} <input type="submit" name="deleteHomeHeaderTitleImage" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" />
<br />
...
<div id="journal-logo-image">
<h4>{translate key="manager.setup.journalLogo"}</h4>

<table width="100%" class="data-alt">
	<tr valign="top">
		<td width="20%" class="label">{translate key="manager.setup.useImageLogo"}</td>
		<td width="80%" class="value"><input type="file" name="homeHeaderLogoImage" class="uploadField" /> <input type="submit" name="uploadHomeHeaderLogoImage" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
	</tr>
</table>

{if $homeHeaderLogoImage[$formLocale]}
{translate key="common.fileName"}: {$homeHeaderLogoImage[$formLocale].name|escape} {$homeHeaderLogoImage[$formLocale].dateUploaded|date_format:$datetimeFormatShort} <input type="submit" name="deleteHomeHeaderLogoImage" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" />
<br />
...
<div id="journal-thumbnail">
<h4>{translate key="manager.setup.journalThumbnail"}</h4>

<table width="100%" class="data-alt">
	<tr valign="top">
		<td width="20%" class="label">{translate key="manager.setup.useThumbnail"}</td>
		<td width="80%" class="value"><input type="file" name="journalThumbnail" class="uploadField" /> <input type="submit" name="uploadJournalThumbnail" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
	</tr>
</table>

{if $journalThumbnail[$formLocale]}
{translate key="common.fileName"}: {$journalThumbnail[$formLocale].name|escape} {$journalThumbnail[$formLocale].dateUploaded|date_format:$datetimeFormatShort} <input type="submit" name="deleteJournalThumbnail" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" />
<br />
...
<div id="manager-journal-homepage-content">
...
<div id="manager-journal-description">
...
<table width="100%" class="data-alt">
	<tr valign="top">
		...
		<td width="80%" class="value"><input type="file" name="homepageImage" class="uploadField" /> <input type="submit" name="uploadHomepageImage" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
	</tr>
</table>

{if $homepageImage[$formLocale]}
{translate key="common.fileName"}: {$homepageImage[$formLocale].name|escape} {$homepageImage[$formLocale].dateUploaded|date_format:$datetimeFormatShort} <input type="submit" name="deleteHomepageImage" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" />
<br />
...
<div id="manager-additional-content">
...
<div id="manager-journal-page-header-info">
...
<table width="100%" class="data-alt">
	...
	<tr valign="top">
		...
		<td width="80%" class="value"><input type="file" name="pageHeaderTitleImage" class="uploadField" /> <input type="submit" name="uploadPageHeaderTitleImage" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
	</tr>
</table>

{if $pageHeaderTitleImage[$formLocale]}
{translate key="common.fileName"}: {$pageHeaderTitleImage[$formLocale].name|escape} {$pageHeaderTitleImage[$formLocale].dateUploaded|date_format:$datetimeFormatShort} <input type="submit" name="deletePageHeaderTitleImage" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" />
<br />
...
<table width="100%" class="data-alt">
	<tr valign="top">
		<td width="20%" class="label">{translate key="manager.setup.useImageLogo"}</td>
		<td width="80%" class="value"><input type="file" name="pageHeaderLogoImage" class="uploadField" /> <input type="submit" name="uploadPageHeaderLogoImage" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
	</tr>
</table>

{if $pageHeaderLogoImage[$formLocale]}
{translate key="common.fileName"}: {$pageHeaderLogoImage[$formLocale].name|escape} {$pageHeaderLogoImage[$formLocale].dateUploaded|date_format:$datetimeFormatShort} <input type="submit" name="deletePageHeaderLogoImage" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" />
<br />
...
<table width="100%" class="data-alt">
	<tr valign="top">
		<td width="20%" class="label">{translate key="manager.setup.useImageLogo"}</td>
		<td width="80%" class="value"><input type="file" name="journalFavicon" class="uploadField" /> <input type="submit" name="uploadJournalFavicon" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
	</tr>
</table>

{if $journalFavicon[$formLocale]}
{translate key="common.fileName"}: {$journalFavicon[$formLocale].name|escape} {$journalFavicon[$formLocale].dateUploaded|date_format:$datetimeFormatShort} <input type="submit" name="deleteJournalFavicon" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" />
<br />
...
<div id="manager-journal-page-footer-info">
...
{foreach name=navItems from=$navItems[$formLocale] key=navItemId item=navItem}
	<tr valign="top">
		...
		<td width="80%" class="value">
			<input type="text" name="navItems[{$formLocale|escape}][{$navItemId|escape}][name]" id="navItems-{$navItemId|escape}-name" value="{$navItem.name|escape}" size="30" maxlength="90" class="textField" /> <input type="submit" name="delNavItem[{$navItemId|escape}]" value="{translate key="common.delete"}" class="btn btn-danger btn-sm" />
			<table width="100%">
				<tr valign="top">
...
<p><input type="submit" name="addNavItem" value="{translate key="manager.setup.addNavItem"}" class="btn btn-sm" /></p>
</div>

<div class="separator"></div>

<div id="manager-journal-layout">
...
<tr>
	...
	<td width="80%" class="value"><input type="file" name="journalStyleSheet" id="journalStyleSheet" class="uploadField" /> <input type="submit" name="uploadJournalStyleSheet" value="{translate key="common.upload"}" class="btn btn-sm" /></td>
</tr>
</table>
...
<div class="separator"></div>
<div id="manager-setup-info">
<h3>5.7 {translate key="manager.setup.information"}</h3>

<p>{translate key="manager.setup.information.description"}</p>

<div id="info-for-readers"><h4>{translate key="manager.setup.information.forReaders"}</h4>
...
<div id="info-for-auth"><h4>{translate key="manager.setup.information.forAuthors"}</h4>
...
<div id="info-for-libs"><h4>{translate key="manager.setup.information.forLibrarians"}</h4>
...
<p style="text-align:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-sm" onclick="document.location.href='{url op="setup" escape=false}'" /> <input type="submit" onclick="prepBlockFields()" value="{translate key="common.saveAndContinue"}" class="btn btn-sm" /></p>
