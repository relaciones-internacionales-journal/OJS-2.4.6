...
{/if}
<div id="manager-focus-and-scope-description">
...
<div id="manager-peer-review-policy">
<h3>2.2 {translate key="manager.setup.peerReviewPolicy"}</h3>
	<div id="peer-review-description">
...
<hr/>
<div id="manager-privacy-statement-info">
...
<hr/>
<div id="manager-editor-decision">
...
<div id="manager-add-item-to-about-journal">
...
<br />
<p><input type="submit" name="addCustomAboutItem" value="{translate key="manager.setup.addAboutItem"}" class="btn btn-sm" /></p>
</div>
<div class="separator"></div>

<div id="manager-journal-archiving">
...
<div id="manager-reviewer-database-link">
...
<p><input type="submit" name="addReviewerDatabaseLink" value="{translate key="manager.setup.addReviewerDatabaseLink"}" class="btn btn-sm" /></p>
</div>
