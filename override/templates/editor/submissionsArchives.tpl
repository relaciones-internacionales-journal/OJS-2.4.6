...
<div id="editor-submissions">
	<div class="editor-article-list-head">		
		...
		<div class="title-shorter">{sort_search key="article.title" sort="title"}</div>
	...
	<div class="editor-article-list" {if $submission->getFastTracked()} class="fastTracked"{/if}>		
		...
		<div class="title-shorter"><a href="{url op="submissionEditing" path=$articleId}" class="action">{$submission->getLocalizedTitle()|strip_tags|truncate:60:"..."}</a></div>
		<div class="status">
