...
<div class="issue-create-form" style="font-size:12px;">
	<form id="issue" method="post" action="{url op="editIssue" path=$issueId}" enctype="multipart/form-data">
		...
		{/if}
			...
			<div class="form-group">
				...
				<input type="text" name="number" id="number" value="{$number|escape}" size="5" maxlength="10" class="textField" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label">{translate key="common.status"}</label>
					...
					{if $issue->getPublished()}
						...
						<label class="checkbox" for="resetArticlePublicationDates"><input type="checkbox" id="resetArticlePublicationDates" name="resetArticlePublicationDates" />{fieldLabel name="resetArticlePublicationDates" key="editor.issues.resetArticlePublicationDates"}</label>
					{else}
		...
		<div id="issue-cover">
			...
			<div class="form-group">
				...
				<span class="help-block">{translate key="common.altTextInstructions"}</span>
			</div>
			<div class="form-group">
		...
		<div class="save">
			...
			<p><input type="button" value="{translate key="common.cancel"}" onclick="document.location.href='{url op="issueData" path=$issueId escape=false}'" class="btn btn-danger btn-sm" /> <input type="submit" value="{translate key="common.save"}" class="btn btn-sm" /></p>
