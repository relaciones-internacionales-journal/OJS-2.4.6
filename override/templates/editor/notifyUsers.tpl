...
<label class="checkbox"><input type="checkbox" name="sendToMailList" />
...
<table id="email" class="data-alt" width="100%">
<tr valign="top">
...
<p style="float:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-sm" onclick="history.go(-1)" /> <input name="send" type="submit" value="{translate key="email.send"}" class="btn btn-sm" /></p>
</div>
</form>
</div>
