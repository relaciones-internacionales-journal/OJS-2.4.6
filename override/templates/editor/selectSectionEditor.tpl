...
<form id="submit" method="post" action="{url op="assignEditor" path=$rolePath articleId=$articleId}">
	...
	<input type="text" name="search" class="textField" value="{$search|escape}" />&nbsp;<input type="submit" value="{translate key="common.search"}" class="btn btn-sm" />
</form>
<hr/>
...
<tr valign="top">
	...
	<td><a class="action assign-general" href="{url op="assignEditor" articleId=$articleId editorId=$editorId}">{translate key="common.assign"}</a></td>
</tr>
