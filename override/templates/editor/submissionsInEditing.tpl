 ...
 *
 *}
<div id="editor-submissions-inreview">
	<div class="editor-article-list-head">
		...
		<div class="editor-selected">{translate key="article.sectionEditor"}</div>
	</div>
	...
	<div class="editor-article-list"{*{if $highlightClass || $fastTracked} class="{$highlightClass|escape} {if $fastTracked}fastTracked{/if}"{/if}*}>
