...
{else}
	<tr>
		<td align="left" class="table-results-pagination">{page_info iterator=$reviewForms}</td>
		<td align="right" class="table-results-pagination">{page_links anchor="reviewForms" name="reviewForms" iterator=$reviewForms}</td>
	</tr>
{/if}
</table>
</div>
