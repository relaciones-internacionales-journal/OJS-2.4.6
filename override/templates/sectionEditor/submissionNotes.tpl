...
{elseif $noteViewType == "add"}
	...
	<div class="control-group">
		...
		<span class="btn btn-file btn-sm"><input type="file" name="upload" class="uploadField" />{translate key="plugins.block.navigation.journalContent"}</span>
	</div>
	<br/>
...
<a class="action buscar-general" href="javascript:toggleNoteAll()"><div style="display:inline" id="expandNotes" name="expandNotes">{translate key="submission.notes.expandNotes"}</div><div style="display: none" id="collapseNotes" name="collapseNotes">{translate key="submission.notes.collapseNotes"}</div></a> |
