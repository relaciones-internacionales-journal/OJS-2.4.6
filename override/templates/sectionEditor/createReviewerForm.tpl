...
{/if}
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="username" id="username" value="{$username|escape}" size="20" maxlength="32" class="textField  input-xlarge" />&nbsp;&nbsp;<input type="button" class="btn btn-sm" value="{translate key="common.suggest"}" onclick="generateUsername()" />
			<br />
	...
	<div class="control-group">
		<label class="control-label">{fieldLabel name="orcid" key="user.orcid"}</label>
		<div class="controls"><input type="text" name="orcid" id="orcid" value="{$orcid|escape}" size="30" maxlength="255" class="textField input-xlarge" />
		</div>
	</div>
	<div class="control-group">
...
<p style="text-align:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-sm" onclick="document.location.href='{url op="selectReviewer" path=$articleId escape=false}'" /> <input type="submit" value="{translate key="common.save"}" class="btn btn-sm" /></p>
