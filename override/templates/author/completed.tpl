...
{else}
	<tr>
		<td align="left" colspan="3" class="table-results-pagination">{page_info iterator=$submissions}</td>
		<td align="right" class="table-results-pagination">{page_links anchor="submissions" name="submissions" iterator=$submissions sort=$sort sortDirection=$sortDirection}</td>
	</tr>
{/if}
</table>
</div>
