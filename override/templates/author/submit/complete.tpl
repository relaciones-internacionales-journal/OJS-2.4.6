...
<div id="author-submission-complete">
...
{if $canExpedite}
	...
	<p>{translate key="author.submit.expedite" expediteUrl=$expediteUrl}</p>
{/if}
...
<p><a href="{url op="index"}" class="search-general">{translate key="author.track"}</a></p>
