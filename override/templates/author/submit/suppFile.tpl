...
<p class="author-submit-backtopage"><a href="{url op="submit" path=4 articleId=$articleId}">&lt;&lt; {translate key="author.submit.backToSupplementaryFiles"}</a></p>
...
{/if}
<div id="author-submit-supplementary-file-data">
...
<div id="author-submit-supplementary-file-upload">
...
<p style="text-align:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-sm" onclick="document.location.href='{url op="submit" path="4" articleId=$articleId escape=false}'" /> <input type="submit" value="{translate key="common.saveAndContinue"}" class="btn btn-sm" /> </p>
