...
{/if}
	...
	<td class="label">{translate key="admin.settings.security"}</td>
		<td colspan="2" class="value">
			<label class="checkbox"><input type="checkbox" name="preventManagerPluginManagement" id="preventManagerPluginManagement" value="1"{if $preventManagerPluginManagement} checked="checked"{/if} />
			{fieldLabel name="preventManagerPluginManagement" key="admin.settings.security.plugins"}</label><br />
		</td>
	</tr>
</table>
