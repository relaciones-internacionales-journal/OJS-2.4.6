...
<table width="100%" class="listing" id="adminJournals">
	...
	{else}
		...
		<tr>
			<td colspan="2" align="left" class="table-results-pagination">{page_info iterator=$journals}</td>
			<td colspan="2" align="right" class="table-results-pagination">{page_links anchor="journals" name="journals" iterator=$journals}</td>
		</tr>
	{/if}
</table>
</div>
<p><a href="{url op="createJournal"}" class="action crear-general">{translate key="admin.journals.create"}</a></p>
