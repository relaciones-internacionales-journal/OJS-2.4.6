...
{if $latestVersionInfo}
	...
	{/if}
{else}
<p><a href="{url versionCheck=1}" class="buscar-general">{translate key="admin.version.checkForUpdates"}</a></p>
{/if}
</div>
<hr/>
...
<a href="{url op="phpinfo"}" target="_blank" class="info-general">{translate key="admin.phpInfo"}</a>
</div>
