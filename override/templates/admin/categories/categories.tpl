...
{else}
	<tr>
		<td align="left" class="table-results-pagination">{page_info iterator=$categories}</td>
		<td align="right" class="table-results-pagination">{page_links anchor="categories" name="categories" iterator=$categories}</td>
	</tr>
{/if}
</table>

<a href="{url op="createCategory"}" class="action crear-general">{translate key="admin.categories.create"}</a>
</div>
